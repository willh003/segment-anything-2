...
class MaskDecoder(nn.Module):
    ...
    def forward_embeddings(
        ...
        """
        WILL
        Predict masks and embeddings given image and prompt embeddings.
        ...
        Returns:
          ...
          torch.Tensor: batched SAM token for mask output
        """
        upscaled_embedding, best_masks, best_iou_pred, mask_tokens_out, object_score_logits = self.predict_masked_embeddings(
            image_embeddings=image_embeddings,
            image_pe=image_pe,
            sparse_prompt_embeddings=sparse_prompt_embeddings,
            dense_prompt_embeddings=dense_prompt_embeddings,
        ...
        # Prepare output
        return upscaled_embedding, best_masks, best_iou_pred, sam_tokens_out, object_score_logits

    def predict_masked_embeddings(self,
        image_embeddings: torch.Tensor,
        image_pe: torch.Tensor,
        sparse_prompt_embeddings: torch.Tensor,
        dense_prompt_embeddings: torch.Tensor,
        ...
        Given a set of image embeddings and prompts, predict sets of embeddings for each mask
        """
        s = 0
        if self.pred_obj_scores:
            output_tokens = torch.cat(
